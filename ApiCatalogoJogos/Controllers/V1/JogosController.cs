...
namespace ApiCatalogoJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<JogoViewModel>>> getJogo([FromQuery, Range(1, int.MaxValue)] int pagina = 1, [FromQuery, Range(1, 50)] int quantidade = 5)
        {
        ...
        [HttpGet("{idJogo:guid}")]
        public async Task<ActionResult<List<JogoViewModel>>> getJogo([FromRoute] Guid idJogo)
        {
        ...
        public async Task<ActionResult<JogoViewModel>> InserirJogo([FromBody] JogoInputModel JogoInputModel)
        {
            ...
            {
                return UnprocessableEntity("Já existe um jogo com esse nome");
            }
        ...
        public async Task<ActionResult> AtualizarJogo([FromRoute] Guid idJogo, [FromBody] JogoInputModel JogoInputModel)
        {
            ...
            {
                return NotFound("Não existe tal jogo");
            }
        }
